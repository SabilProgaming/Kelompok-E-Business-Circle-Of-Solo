...
@php
    ...
    $variantClasses = [
        'primary' => 'bg-luxury-charcoal text-white hover:bg-luxury-gold hover:text-luxury-charcoal focus:ring-[var(--color-primary)]',
        'secondary' => 'bg-luxury-black text-[var(--color-primary)] hover:bg-[#b5952f] focus:ring-[var(--color-secondary)] border border-[var(--color-secondary)]',
